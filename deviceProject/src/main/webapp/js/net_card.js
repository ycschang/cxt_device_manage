...
layui.use([ 'layer', 'form','table'], function() {
	var form = layui.form, layer = layui.layer,table = layui.table;
	 var tableIns = table.render({
	    elem: '#deviceList',
	    method:"post",
	    url:"${pageContext.request.contextPath}../../../netCard/getNet_CardPageInfo.action",
	    cellMinWidth : 95,
	    page : true,
	    height : "full-125",
	    limit : 10,
	    ...
	    cols : [[
	        ...
	        {field: 'net_card', title: '物联网卡号', width:350},
	        {field: 'device_name', title: '姓名', align:'center'},
	        //{field: 'device_type', title: '物联网卡类型',  align:'center'},
	        {field: 'card_status', title: '物联网卡状态', align:'center'},
